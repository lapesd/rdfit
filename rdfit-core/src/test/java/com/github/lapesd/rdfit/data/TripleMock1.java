...
public class TripleMock1 implements TripleMock {
    private final @Nonnull String subject, predicate, object;

    public TripleMock1(@Nonnull String subject, @Nonnull String predicate, @Nonnull String object) {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TripleMock1)) return false;
        TripleMock1 triple = (TripleMock1) o;
