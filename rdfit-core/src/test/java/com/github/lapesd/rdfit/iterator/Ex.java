...
public class Ex {
    ...
    public static final @Nonnull TripleMock3 V1 = new TripleMock3(S1, P1, O1);
    public static final @Nonnull TripleMock3 V2 = new TripleMock3(S2, P2, O2);
    public static final @Nonnull TripleMock3 V3 = new TripleMock3(S3, P3, O3);
    public static final @Nonnull TripleMock3 V4 = new TripleMock3(S4, P4, O4);
    public static final @Nonnull TripleMock3 V5 = new TripleMock3(S5, P5, O5);
    public static final @Nonnull TripleMock3 V6 = new TripleMock3(S6, P6, O6);
